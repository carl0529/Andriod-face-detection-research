package com.android.example.camerax.tflite.ml;
...
public final class CocoSsdMobilenetV110Quant {
  @NonNull
  private final Model model;

  private CocoSsdMobilenetV110Quant(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "coco_ssd_mobilenet_v1_1.0_quant.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static CocoSsdMobilenetV110Quant newInstance(@NonNull Context context) throws IOException {
    return new CocoSsdMobilenetV110Quant(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static CocoSsdMobilenetV110Quant newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new CocoSsdMobilenetV110Quant(context, options);
  }
