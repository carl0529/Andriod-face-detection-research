...
public final class FacenetHiroki {
  @NonNull
  private final Model model;

  private FacenetHiroki(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "facenet_hiroki.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static FacenetHiroki newInstance(@NonNull Context context) throws IOException {
    return new FacenetHiroki(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FacenetHiroki newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new FacenetHiroki(context, options);
  }
